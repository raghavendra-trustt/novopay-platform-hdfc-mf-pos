...
//var emvParameter="9F01063132333435369F40057000F0A0019F150230319F160F3132333435363738393031323334359F3901059F330360D0C89F1A0203569F1C0831323334353637389F3501225F2A0203565F3601029F3C0203569F3D01029F1E086D665F36306220209F660434000080";
var emvParameter="9F01063132333435369F40057000F0A0019F150230319F160F3132333435363738393031323334359F3901059F330360D0C89F1A0203569F1C0831323334353637389F3501225F2A0203565F3601029F3C0203569F3D01029F1E086D665F36306220209F660434000080";

$(document).ready(function(){
	downloadPUK=$("#downloadPUK");
	dukptInit=$("#dukptInit");
	setEMV=$("#setEMV");
	upload=$("#upload");
	downloadAID=$("#downloadAID");
	
	
	downloadAID.click(function(){
		loadAID();
	});
	downloadPUK.click(function(){
		loadCAPK();
	});
	dukptInit.click(function(){
		initDUKPT();
	});
	
	setEMV.click(function(){
...
function loadCAPK()
{
	var capkList=[ "",
...
{
url = "/mp63/init_dukpt";
var dukptData={"bkd":"C1D0F8FB4958670DBA40AB1F3752EF0D","ksn":"FFFF9876543210000000"}
	

$.ajax({
  url:url,
  type:"POST",
  data: JSON.stringify(dukptData),
  contentType:"application/json; charset=utf-8",
  dataType:"json",
  success: function(data, textStatus){
	try {
...
function setEMVParam()
{
	url = "/mp63/load_emv_param?emvParam="+emvParameter;
